...
let masterImage = 'mastermind.jpg';
...
let bitImage = 'bitfellows.jpg';
let bitPara = 'Full stack app using JavaScript, HTML, CSS and postgreSQL pulling from a couple API\'s to display current crypto prices.'
